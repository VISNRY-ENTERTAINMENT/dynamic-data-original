...
The reference implementation has been dogfooded on a real production codebase
with project-specific charters (domain-purity rules, live-integration coverage,
a fixed set of architectural invariants) that a new project adapts to its own.
New projects should use the `dd_core.reflex` module directly.
