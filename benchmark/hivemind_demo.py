...
def main():
    ...
    ddb.assert_claim("exampleapp", "head_commit", "abc1234", source="scout",
                     confidence=1.0, author_kind="ai", signer=scout_key,
                     evidence="scout skimmed the log")
    p_claim = ddb.assert_claim("exampleapp", "head_commit", "91790c1", source="planner",
    ...
    res = ddb.resolve("exampleapp", "head_commit")
