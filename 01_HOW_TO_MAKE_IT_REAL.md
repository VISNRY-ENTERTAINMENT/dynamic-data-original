...
system can't afford (silent data loss). ExampleApp already proves you don't need
...
Pull the Dynamic-Data core out of ExampleApp into a small, domain-agnostic
...
3. **Plug into where you already are** — expose dd-core as an **MCP server** so
   ...
   memory. ExampleApp already lives in an MCP-friendly world.
